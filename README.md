## Vilniaus universiteto Programų sistemų bakalauro praktikos ataskaitos LaTeX šablonas
...
- `make`  
- `make pdf`  
- `latexmk --lualatex --file-line-error --halt-on-error ataskaita.tex` (ta pati komanda, kurią įvykdo kiti du variantai)

### Windows

Įvykdyti `latexmk --lualatex --file-line-error --halt-on-error ataskaita.tex`.
